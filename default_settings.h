...
static Q_DECL_CONSTEXPR int DEFAULT_HISTORY_MAX_SIZE = 10;
...
static Q_DECL_CONSTEXPR bool DEFAULT_FOLDER_COLOR_TOP_PRIORITY = true;

static Q_DECL_CONSTEXPR qreal DEFAULT_FOLDER_VIEW_ROW_HEIGHT = 1.5;
